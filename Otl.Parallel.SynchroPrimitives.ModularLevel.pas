unit Otl.Parallel.SynchroPrimitives.ModularLevel;
// IMPORTANT!
...
uses Otl.Parallel.SynchroPrimitives.InterfaceLevel, System.SyncObjs
   ...
   , Otl.Parallel.SynchroPrimitives.ConditionVariables
 {$IFDEF MSWINDOWS}
   , Winapi.Windows
 {$ENDIF}
   , Otl.Parallel.Atomic;
...
type
  ...
  private
    ...
    function  SignalState: Otl.Parallel.SynchroPrimitives.InterfaceLevel.TSignalState;
  ...
  private
    ...
    FLock: ILock;
    FDatum: TObject;
    FCondVar: Otl.Parallel.SynchroPrimitives.ConditionVariables.TSBDConditionVariable;
...
uses System.Diagnostics, Otl.Parallel.Errors;
...
function TCompositeSynchro.SignalState: Otl.Parallel.SynchroPrimitives.InterfaceLevel.TSignalState;
begin
...
function TModularSynchro.SignalState: Otl.Parallel.SynchroPrimitives.InterfaceLevel.TSignalState;
begin
